...
pairs(~mpg01 + cylinders + displacement + horsepower + weight, 
      data = Auto, 
      col = c("blue", "cornflowerblue", "purple", "green"))
par(mfrow = c(2,2))
plot(Auto$cylinders, mpg01, col = "blue", xlab = "cylinders", main = "cylinders vs. mpg01")
plot(Auto$displacement, mpg01, col = "blue", xlab = "displacement", main = "displacement vs. mpg01")
plot(Auto$horsepower, mpg01, col = "blue", xlab = "horsepower", main = "horsepower vs. mpg01")
plot(Auto$weight, mpg01, col = "blue", xlab = "weight", main = "weight vs. mpg01")
